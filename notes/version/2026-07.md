...
- **Security workflows** (SHA-pinned): `codeql.yml` (`java-kotlin`, build-mode manual —
  Kotlin is compiled, unlike the sibling's JS) and `scorecard.yml` (OpenSSF Scorecard,
  weekly + branch-protection + push-to-main). Dependabot already covered gradle + actions.
