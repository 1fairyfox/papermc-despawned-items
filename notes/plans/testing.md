...
- `/recycle` never rewarded (scoreboard objectives absent) → PDC path ⏳ add explicit regression
- Data-bearing particles threw at spawn → validated-at-load ⏳ add explicit regression
